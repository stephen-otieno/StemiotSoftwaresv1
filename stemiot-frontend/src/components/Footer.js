      ...
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <div className="social-icons">
            <a href="https://wa.me/254115598800" target="_blank" rel="noreferrer">
              <FontAwesomeIcon icon={faWhatsapp} />
            </a>
            <a href="https://www.facebook.com/profile.php?id=100065310971717" target="_blank" rel="noreferrer">
              <FontAwesomeIcon icon={faFacebook} />
            </a>
            <a href="https://www.linkedin.com/in/stephen-otieno-9a2833306/" target="_blank" rel="noreferrer">
              <FontAwesomeIcon icon={faLinkedin} />
            </a>
            <a href="https://x.com/Engineerotienos" target="_blank" rel="noreferrer">
